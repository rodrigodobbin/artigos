...
% O processo dessa revisão durou 12 meses, todo trabalho foi feito por três autores, o primeiro autor dessa revisão realizou o processo da RSL e os demais revisaram o trabalho feito pelo primeiro. O processo está descrito na Tabela \ref{tab:processo_rsl}.

% \begin{table}[ht]
%     \centering
%     \caption{Processo de revisão sistemática de literatura}
%     \label{tab:processo_rsl}
%     \begin{tabular}{|c|c|c|} 
%         \hline
%         Data & Atividades & Resultados \\
%       \hline
%         \multirow{2}{*}{Janeiro 2021} &  Desenvolvimento do protocolo da RSL & Esboço do protocolo \\ \cline{2-3}
%         & Revisão do protocolo da RSL & \makecell{Primeira versão do \\ protocolo} \\
%       \hline
%       \multirow{2}{*}{Fevereiro 2021} & Processo de busca & Lista de publicações \\ \cline{2-3}
%       & Revisão do protocolo da RSL & \makecell{Segunda versão do \\ protocolo} \\
%       \hline
%       \multirow{2}{*}{Março 2021} & Processo de busca com \textit{String} adaptada & \makecell{Lista de publicações \\ completa} \\ \cline{2-3}
%       & Remoção dos duplicados & \makecell{Lista sem estudos \\ duplicados} \\
%       \hline
%       Abril 2021 & Primeira revisão & \makecell{Lista de possíveis \\ estudos selecionados} \\ 
%       \hline
%       Maio 2021 & Segunda Revisão & \makecell{Lista com os estudos \\ primários} \\ 
%       \hline
%       \multirow{2}{*}{Junho 2021} & Revisão do protocolo da RSL & \makecell{Terceira versão do \\ protocolo} \\ \cline{2-3}
%       & Extração dos dados & \makecell{Montagem das tabelas \\ com os dados} \\
%       \hline
%       Julho 2021 & Avaliação de qualidade & \makecell{Avaliação da qualidade \\ dos estudos primários} \\
%       \hline
%       Agosto 2021 & \multirow{2}{*}{Síntese dos dados} & \multirow{2}{*}{\makecell{Respostas para as \\ questões de pesquisa}} \\ \cline{1-1}
%       Setembro 2021 & & \\
%       \hline
%       Outubro 2021 & \multirow{3}{*}{Reportando os resultados} & \makecell{Primeira versão do \\ artigo} \\ \cline{1-1} \cline{3-3}
%       Novembro 2021 & & \makecell{Segunda versão do \\ artigo} \\ \cline{1-1} \cline{3-3}
%       Dezembro 2021 & & Versão Final do artigo \\
%       \hline
%     \end{tabular}
% \end{table}

% \subsection{Resultado da busca e seleção}
...
% \subsection{Resultado da avaliação de qualidade}
